const apiKey = "431b16434cc41f0a9952c0c8455fd4f4";
...
async function fetchData(url) {
    try {
        ...
        if (!response.ok) {
            throw new Error("Internet não está respondendo.");
        }
...
function createMovieCard(movie) {
    ...
    const formattedDate = release_date || "Sem data de lançamento.";
    const cardTemplate = `
        <div class="column">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="right-content">
                        <a href="${imagePath}" target="_blank" class="card-btn">Ver cartaz</a>
                    </div>
                </div>
                <div class="info">
...
// Mostra resultados na pagina
function showResults(item) {
    const newContent = item.map(createMovieCard).join("");
    result.innerHTML += newContent || "<p>Não foi encontrado.</p>";
}
...
// Detecta final da pagina e carrega mais
function detectEnd() {
